...
from TikerData import *


class Ui_Form(object):
    def clickButtonTikr():
        print("Hemos clickado el boton")
    def setupUi(self, Form):
        ...
        self.pushButton.clicked(self.clickButtonTikr)
        ...
        tikrData = TikerData("MSFT")
        tikerInfo = tikrData.getHistoricalData()
        print (tikerInfo['longName'])
        self.labelCompanyName.setText(tikerInfo['longName'])
